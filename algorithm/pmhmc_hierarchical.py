...
from approximator import  VariationalInferenceHierarchical, HierarchicalPosterior
...
class PMHMCH:
    ...
    def compile(self,
        ...
        print(jnp.repeat(jnp.expand_dims(self.model_class.y,axis=1),self.num_sample,axis=1).shape)
        def neg_log_prob(z):
            z1 = z[:n_remained]
            ...
            return (- jnp.sum(logpdfs) - self.model_class.prior(z1)  - cond_logdet)
